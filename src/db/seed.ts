...
async function seed() {
  ...
  // ── Vehicles ──
  const vehicleData = [
    { plateNumber: "ABC-1234", brand: "Toyota", model: "Hiace", year: 2022, capacity: 14, chassisNumber: "CHA-001", engineNumber: "ENG-001", hasGps: true, vehicleTypeId: vtIds["BUS"], driverId: null },
    { plateNumber: "XYZ-5678", brand: "Mercedes", model: "Sprinter", year: 2023, capacity: 20, chassisNumber: "CHA-002", engineNumber: "ENG-002", hasGps: true, vehicleTypeId: vtIds["BUS"], driverId: null },
    { plateNumber: "DEF-9012", brand: "Mitsubishi", model: "L300", year: 2021, capacity: 8, chassisNumber: "CHA-003", engineNumber: "ENG-003", hasGps: false, vehicleTypeId: vtIds["VAN"], driverId: null },
    { plateNumber: "GHI-3456", brand: "Nissan", model: "Urvan", year: 2023, capacity: 15, chassisNumber: "CHA-004", engineNumber: "ENG-004", hasGps: true, vehicleTypeId: vtIds["BUS"], driverId: null },
    { plateNumber: "JKL-7890", brand: "Ford", model: "Transit", year: 2022, capacity: 12, chassisNumber: "CHA-005", engineNumber: "ENG-005", hasGps: false, vehicleTypeId: vtIds["VAN"], driverId: null },
  ]
