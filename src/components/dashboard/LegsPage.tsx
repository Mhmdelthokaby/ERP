...
export function LegsPage() {
  const { data, openModal, closeModal, toggleDriverActive, setEditingDriver, sidebarOpen, toggleSidebar, setPage, setPendingVehicleView } = useApp()
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-5">
        ...
        <button className="btn-primary px-4 py-2 rounded-lg text-sm flex items-center gap-2" onClick={() => openModal("addDriverModal")}>
          <i className="fa-solid fa-plus text-xs"></i> إضافة سائق
        </button>
      </div>
