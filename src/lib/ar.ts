export const ar = {
  ...
  suppliers: {
    ...
    noSelection: 'اختر مورداً لعرض التفاصيل',
    added: 'تمت إضافة المورد بنجاح',
  ...
  maintenance: {
    ...
    add: 'إضافة صيانة',
    edit: 'تعديل الصيانة',
    deleteConfirm: 'هل أنت متأكد من حذف سجل الصيانة',
    noSelection: 'اختر سجل صيانة لعرض التفاصيل',
    addType: 'إضافة نوع صيانة',
    editType: 'تعديل نوع الصيانة',
    typeName: 'اسم النوع',
    typeCode: 'كود النوع',
    deleteTypeConfirm: 'هل أنت متأكد من حذف نوع الصيانة',
  },
  maintenanceModals: {
    save: 'حفظ',
    cancel: 'إلغاء',
